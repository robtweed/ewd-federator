/*
 ...
 ----------------------------------------------------------------------------
 | ewdrest: EWD REST Server/Federator                                       |
 |                                                                          |
...
var EWD = {
  ...
  version: function() {
    return 'EWD REST Server: Build ' + this.buildNo + ', ' + this.buildDate;
  },
  ...
  childProcessMessageHandlers: {
    ...
    firstChildInitialised: function(response) {
      ...
      setTimeout(function() {
        ...
        console.log('******************************************************');
        console.log('*******       EWD REST Server is Ready     ***********');
        console.log('******************************************************');
        console.log('  ');
...
module.exports = {
  ...
  start: function(params, callback) {
    ...
    console.log('   ');
    console.log('******************************************************');
    console.log('**** EWD REST Server Build ' + EWD.buildNo + ' (' + EWD.buildDate + ') *******');
    console.log('******************************************************');
    console.log('  ');
    console.log('Started: ' + EWD.started);
